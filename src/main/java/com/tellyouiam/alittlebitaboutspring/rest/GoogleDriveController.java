...
import com.tellyouiam.alittlebitaboutspring.dto.FileItemDTO;
...
public class GoogleDriveController {
	...
	private static final String USER_IDENTIFIER_KEY = "AIzaSyCDlvX4OtARtjFNoP7cAL2DWJCWJQP5qPY";
	...
	public void createFile(HttpServletResponse response) throws Exception {
		...
		Drive drive = new Drive.Builder(HTTP_TRANSPORT, JSON_FACTORY, cred)
				.setApplicationName("googledrivestringbootdemo").build();
		
		File file = new File();
		file.setName("profile.jpg");
		
		FileContent content = new FileContent("image/jpeg", new java.io.File("/home/logbasex/Pictures/Donald Trump.jpg"));
