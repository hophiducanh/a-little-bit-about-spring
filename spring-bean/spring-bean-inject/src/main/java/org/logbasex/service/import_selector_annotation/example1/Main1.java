...
public class Main1 {
	...
	public static void main(String[] args) {
		...
		//			}
		ConfigurableApplicationContext run = SpringApplication.run(Main1.class, args);
		...
		ApplicationContext context = new AnnotationConfigApplicationContext(Main1.class);
